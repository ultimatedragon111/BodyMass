...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioButton relativeFat;
    private RadioButton wanDer;
    private RadioButton loretz;
    private RadioButton creff;
    private RadioButton broad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relativeFat = findViewById(R.id.relativeFat);
        wanDer = findViewById(R.id.wanDer);
        loretz = findViewById(R.id.loretz);
